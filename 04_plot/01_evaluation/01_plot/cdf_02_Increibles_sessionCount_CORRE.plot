...
set output "04_plot/01_evaluation/02_eps/cdf_02_Increibles_sessionCount_CORRECTION.eps"
...
#'04_plot/01_evaluation/00_data/session_countcdf_02_Increibles_SNAP_CORRECTED_RES-100_FAIL-000_ALP-060.txt' using 2:1 title 'Out {/Symbol a}=.60' with lp ls 2,\
#'04_plot/01_evaluation/00_data/session_countcdf_02_Increibles_SNAP_CORRECTED_RES-100_FAIL-000_ALP-075.txt' using 2:1 title 'Out {/Symbol a}=.75' with lp ls 3,\
#'04_plot/01_evaluation/00_data/session_countcdf_02_Increibles_SNAP_CORRECTED_RES-100_FAIL-000_ALP-080.txt' using 2:1 title 'Out {/Symbol a}=.80' with lp ls 5,\
#'04_plot/01_evaluation/00_data/session_countcdf_02_Increibles_SNAP_CORRECTED_RES-100_FAIL-000_ALP-085.txt' using 2:1 title 'Out {/Symbol a}=.85' with lp ls 6,\
#'04_plot/01_evaluation/00_data/session_countcdf_02_Increibles_SNAP_CORRECTED_RES-100_FAIL-000_ALP-090.txt' using 2:1 title 'Out {/Symbol a}=.90' with lp ls 4,\
#'04_plot/01_evaluation/00_data/session_countcdf_02_Increibles_SNAP_CORRECTED_RES-100_FAIL-000_ALP-095.txt' using 2:1 title 'Out {/Symbol a}=.95' with lp ls 7
...
set output "04_plot/01_evaluation/03_png/cdf_02_Increibles_sessionCount_CORRECTION.png"
set term png
replot
