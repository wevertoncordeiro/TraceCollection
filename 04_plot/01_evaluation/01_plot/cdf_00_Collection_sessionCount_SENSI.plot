...
#session_countcdf_00_Collection_SNAP_CORRECTED_RES-100_FAIL-000_ALP-080
#session_countcdf_00_Collection_SNAP_ORIGINAL_RES-100_FAIL-000

set output "04_plot/01_evaluation/cdf_00_Collection_sessionCount_SENSI_failure-025.eps"  
plot                                                                                                                                                         '04_plot/01_evaluation/00_data/session_countcdf_00_Collection_SNAP_ORIGINAL_RES-100_FAIL-000.txt' using 2:1 title 'In Original' with lp ls 1 ,  '04_plot/01_evaluation/00_data/session_countcdf_00_Collection_SNAP_ORIGINAL_RES-100_FAIL-025.txt' using 2:1 title "In p_{if}=.25" with lp ls 7, '04_plot/01_evaluation/00_data/session_countcdf_00_Collection_SNAP_CORRECTED_RES-100_FAIL-025_ALP-060.txt' using 2:1 title "Out {/Symbol a}=.60 p_{if}=.25" with lp ls 4, '04_plot/01_evaluation/00_data/session_countcdf_00_Collection_SNAP_CORRECTED_RES-100_FAIL-025_ALP-075.txt' using 2:1 title "Out {/Symbol a}=.75 p_{if}=.25" with lp ls 8, '04_plot/01_evaluation/00_data/session_countcdf_00_Collection_SNAP_CORRECTED_RES-100_FAIL-025_ALP-095.txt' using 2:1 title "Out {/Symbol a}=.95 p_{if}=.25" with lp ls 6, 

#'04_plot/01_evaluation/00_data/session_countcdf_00_Collection_SNAP_CORRECTED_RES-100_FAIL-025_ALP-085.txt' using 2:1 title "Out {/Symbol a}=.85 p_{if}=.25" with lp ls 6, #'04_plot/01_evaluation/00_data/session_countcdf_00_Collection_SNAP_CORRECTED_RES-100_FAIL-025_ALP-095.txt' using 2:1 title "Out {/Symbol a}=.95 p_{if}=.25" with lp ls 10,  
