...
set output "04_plot/01_evaluation/cdf_sessionCount_BENCH_a75_00_01.eps"  
...
plot \
'04_plot/01_evaluation/00_data/session_countcdf_00_Collection_SNAP_ORIGINAL_RES-100_FAIL-025.txt' using 2:1 title 'In p_{if}=.25' with lp ls 7 ,\
'04_plot/01_evaluation/00_data/session_countcdf_00_Collection_SNAP_ORIGINAL_RES-100_FAIL-020.txt' using 2:1 title 'In p_{if}=.20' with lp ls 5 ,\
'04_plot/01_evaluation/00_data/session_countcdf_00_Collection_SNAP_ORIGINAL_RES-100_FAIL-015.txt' using 2:1 title 'In p_{if}=.15' with lp ls 3 ,\
'04_plot/01_evaluation/00_data/session_countcdf_00_Collection_SNAP_ORIGINAL_RES-100_FAIL-000.txt' using 2:1 title 'In Original' with lp ls 1 ,\
'04_plot/01_evaluation/00_data/session_countcdf_00_Collection_SNAP_CORRECTED_RES-100_FAIL-025_ALP-075.txt' using 2:1 title 'Out p_{if}=.25 {/Symbol a}=.75' with lp ls 8 ,\
'04_plot/01_evaluation/00_data/session_countcdf_00_Collection_SNAP_CORRECTED_RES-100_FAIL-020_ALP-075.txt' using 2:1 title 'Out p_{if}=.20 {/Symbol a}=.75' with lp ls 6 ,\
'04_plot/01_evaluation/00_data/session_countcdf_00_Collection_SNAP_CORRECTED_RES-100_FAIL-015_ALP-075.txt' using 2:1 title 'Out p_{if}=.15 {/Symbol a}=.75' with lp ls 4 ,\
'04_plot/01_evaluation/00_data/session_countcdf_00_Collection_SNAP_CORRECTED_RES-100_FAIL-000_ALP-075.txt' using 2:1 title 'Out Original {/Symbol a}=.75' with lp ls 2,  
...
plot  \
'04_plot/01_evaluation/00_data/session_countcdf_01_Aerofly_SNAP_ORIGINAL_RES-100_FAIL-025.txt' using 2:1 title 'In p_{if}=.25' with lp ls 7 , \
'04_plot/01_evaluation/00_data/session_countcdf_01_Aerofly_SNAP_ORIGINAL_RES-100_FAIL-020.txt' using 2:1 title 'In p_{if}=.20' with lp ls 5 , \
'04_plot/01_evaluation/00_data/session_countcdf_01_Aerofly_SNAP_ORIGINAL_RES-100_FAIL-015.txt' using 2:1 title 'In p_{if}=.15' with lp ls 3 , \
'04_plot/01_evaluation/00_data/session_countcdf_01_Aerofly_SNAP_ORIGINAL_RES-100_FAIL-000.txt' using 2:1 title 'In Original' with lp ls 1 ,   \
'04_plot/01_evaluation/00_data/session_countcdf_01_Aerofly_SNAP_CORRECTED_RES-100_FAIL-025_ALP-075.txt' using 2:1 title 'Out p_{if}=.25 {/Symbol a}=.75' with lp ls 8 , \
'04_plot/01_evaluation/00_data/session_countcdf_01_Aerofly_SNAP_CORRECTED_RES-100_FAIL-020_ALP-075.txt' using 2:1 title 'Out p_{if}=.20 {/Symbol a}=.75' with lp ls 6 , \
'04_plot/01_evaluation/00_data/session_countcdf_01_Aerofly_SNAP_CORRECTED_RES-100_FAIL-015_ALP-075.txt' using 2:1 title 'Out p_{if}=.15 {/Symbol a}=.75' with lp ls 4 , \
'04_plot/01_evaluation/00_data/session_countcdf_01_Aerofly_SNAP_CORRECTED_RES-100_FAIL-000_ALP-075.txt' using 2:1 title 'Out Original {/Symbol a}=.75' with lp ls 2,  
