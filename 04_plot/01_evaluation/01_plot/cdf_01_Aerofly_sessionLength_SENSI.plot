...
#set output "04_plot/01_evaluation/cdf_01_Aerofly_sessionLength_SENSI_failure-050.eps"  
#plot                                                                                                                                                                  '04_plot/01_evaluation/00_data/session_lengthcdf_01_Aerofly_SNAP_ORIGINAL_RES-100_FAIL-000.txt' using 2:1 title 'In Original' with lp ls 1 ,                             '04_plot/01_evaluation/00_data/session_lengthcdf_01_Aerofly_SNAP_ORIGINAL_RES-100_FAIL-050.txt' using 2:1 title 'In p_{if}=.50' with lp ls 7 ,                           '04_plot/01_evaluation/00_data/session_lengthcdf_01_Aerofly_SNAP_CORRECTED_RES-100_FAIL-050_ALP-080.txt' using 2:1 title 'Out p_{if}=.50 {/Symbol a}=.80' with lp ls 4, '04_plot/01_evaluation/00_data/session_lengthcdf_01_Aerofly_SNAP_CORRECTED_RES-100_FAIL-050_ALP-085.txt' using 2:1 title 'Out p_{if}=.50 {/Symbol a}=.85' with lp ls 2, '04_plot/01_evaluation/00_data/session_lengthcdf_01_Aerofly_SNAP_CORRECTED_RES-100_FAIL-050_ALP-090.txt' using 2:1 title 'Out p_{if}=.50 {/Symbol a}=.90' with lp ls 8, '04_plot/01_evaluation/00_data/session_lengthcdf_01_Aerofly_SNAP_CORRECTED_RES-100_FAIL-050_ALP-095.txt' using 2:1 title 'Out p_{if}=.50 {/Symbol a}=.95' with lp ls 6, 
 
 set output "04_plot/01_evaluation/cdf_01_Aerofly_sessionLength_SENSI_failure-025.eps"  
 plot                                                                                                                                                         '04_plot/01_evaluation/00_data/session_lengthcdf_01_Aerofly_SNAP_ORIGINAL_RES-100_FAIL-000.txt' using 2:1 title 'In Original' with lp ls 1 ,  '04_plot/01_evaluation/00_data/session_lengthcdf_01_Aerofly_SNAP_ORIGINAL_RES-100_FAIL-025.txt' using 2:1 title "In p_{if}=.25" with lp ls 7, '04_plot/01_evaluation/00_data/session_lengthcdf_01_Aerofly_SNAP_CORRECTED_RES-100_FAIL-025_ALP-060.txt' using 2:1 title "Out {/Symbol a}=.60 p_{if}=.25" with lp ls 4, '04_plot/01_evaluation/00_data/session_lengthcdf_01_Aerofly_SNAP_CORRECTED_RES-100_FAIL-025_ALP-075.txt' using 2:1 title "Out {/Symbol a}=.75 p_{if}=.25" with lp ls 8, '04_plot/01_evaluation/00_data/session_lengthcdf_01_Aerofly_SNAP_CORRECTED_RES-100_FAIL-025_ALP-095.txt' using 2:1 title "Out {/Symbol a}=.95 p_{if}=.25" with lp ls 6,  
