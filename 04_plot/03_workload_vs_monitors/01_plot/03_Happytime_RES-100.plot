...
set yrange [:1000]
set output "04_plot/03_workload_vs_monitors/02_eps/03_Happytime_RES-100_queries.eps"
...
set yrange [:5000]
set output "04_plot/03_workload_vs_monitors/02_eps/03_Happytime_RES-100_peers.eps"
