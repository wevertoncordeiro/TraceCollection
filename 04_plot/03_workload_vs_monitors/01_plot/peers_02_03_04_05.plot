...
set output "04_plot/03_workload_vs_monitors/peers_02_03_04_05.eps"
...
#S3
plot \
'04_plot/03_workload_vs_monitors/00_data/03_Happytime_RES-100.txt' using ($1):($13+$16) title 'Collected Unique Peers' with p ls 1,\
'04_plot/03_workload_vs_monitors/00_data/03_Happytime_RES-100.txt' using ($1):10        title 'Sum Peers' with p ls 2,\
'04_plot/03_workload_vs_monitors/00_data/03_Happytime_RES-100.txt' using ($1):9         title 'Max Peers' with p ls 3
...
#S4
plot \
'04_plot/03_workload_vs_monitors/00_data/02_Increibles_RES-100.txt' using ($1):($13+$16) title 'Collected Unique Peers' with p ls 1,\
'04_plot/03_workload_vs_monitors/00_data/02_Increibles_RES-100.txt' using ($1):10        title 'Sum Peers' with p ls 2,\
'04_plot/03_workload_vs_monitors/00_data/02_Increibles_RES-100.txt' using ($1):9         title 'Max Peers' with p ls 3
...
#S5
plot \
'04_plot/03_workload_vs_monitors/00_data/05_Mission_RES-100.txt' using ($1):($13+$16) title 'Collected Unique Peers' with p ls 1,\
'04_plot/03_workload_vs_monitors/00_data/05_Mission_RES-100.txt' using ($1):10        title 'Sum Peers' with p ls 2,\
'04_plot/03_workload_vs_monitors/00_data/05_Mission_RES-100.txt' using ($1):9         title 'Max Peers' with p ls 3
...
#S6
plot \
'04_plot/03_workload_vs_monitors/00_data/04_Star_RES-100.txt' using ($1):($13+$16) title 'Collected Unique Peers' with p ls 1,\
'04_plot/03_workload_vs_monitors/00_data/04_Star_RES-100.txt' using ($1):10        title 'Sum Peers' with p ls 2,\
'04_plot/03_workload_vs_monitors/00_data/04_Star_RES-100.txt' using ($1):9         title 'Max Peers' with p ls 3
