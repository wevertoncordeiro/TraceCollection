...
unset key
set encoding utf8
set xlabel "Number of Peer Lists"
set ylabel "CDF"
...
set output "04_plot/03_workload_vs_monitors/peerlists_00_01.eps"
...
plot \
'04_plot/03_workload_vs_monitors/00_data/00_Collection_RES-100.txt' using ($1):4  title 'Collected Peer Lists' with p ls 1, \
'04_plot/03_workload_vs_monitors/00_data/00_Collection_RES-100.txt' using ($1):21 title 'Est. Req., N=(Sum), L=200' with p ls 2, \
'04_plot/03_workload_vs_monitors/00_data/00_Collection_RES-100.txt' using ($1):20 title 'Est. Req., N=(Max), L=200' with p ls 3
