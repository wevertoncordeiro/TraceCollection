...
set output "fig8_cdf_sessionLength_BENCH_a75_00_01.eps"  
...
set arrow from 20,.98 to 20,.85 as 1
set label "gain" at 21,.97
...
'04_plot/01_evaluation/00_data/session_lengthcdf_00_Collection_SNAP_ORIGINAL_RES-100_FAIL-020.txt' using 2:1 title 'In p_{if}=.20' with l ls 5 ,\
'04_plot/01_evaluation/00_data/session_lengthcdf_00_Collection_SNAP_ORIGINAL_RES-100_FAIL-015.txt' using 2:1 title 'In p_{if}=.15' with l ls 3 ,\
...
'04_plot/01_evaluation/00_data/session_lengthcdf_00_Collection_SNAP_CORRECTED_RES-100_FAIL-025_ALP-075.txt' using 2:1 title 'Out p_{if}=.25 {/Symbol a}=.75' with l ls 8 ,\
'04_plot/01_evaluation/00_data/session_lengthcdf_00_Collection_SNAP_CORRECTED_RES-100_FAIL-020_ALP-075.txt' using 2:1 title 'Out p_{if}=.20 {/Symbol a}=.75' with l ls 6 ,\
'04_plot/01_evaluation/00_data/session_lengthcdf_00_Collection_SNAP_CORRECTED_RES-100_FAIL-015_ALP-075.txt' using 2:1 title 'Out p_{if}=.15 {/Symbol a}=.75' with l ls 4 ,\
'04_plot/01_evaluation/00_data/session_lengthcdf_00_Collection_SNAP_CORRECTED_RES-100_FAIL-000_ALP-075.txt' using 2:1 title 'Out Original {/Symbol a}=.75' with l ls 2,  
...
set arrow from 17,.98 to 17,.81 as 1
set label "gain" at 18,.97
...
'04_plot/01_evaluation/00_data/session_lengthcdf_01_Aerofly_SNAP_ORIGINAL_RES-100_FAIL-020.txt' using 2:1 title 'In p_{if}=.20' with l ls 5 , \
'04_plot/01_evaluation/00_data/session_lengthcdf_01_Aerofly_SNAP_ORIGINAL_RES-100_FAIL-015.txt' using 2:1 title 'In p_{if}=.15' with l ls 3 , \
...
'04_plot/01_evaluation/00_data/session_lengthcdf_01_Aerofly_SNAP_CORRECTED_RES-100_FAIL-025_ALP-075.txt' using 2:1 title 'Out p_{if}=.25 {/Symbol a}=.75' with l ls 8 , \
'04_plot/01_evaluation/00_data/session_lengthcdf_01_Aerofly_SNAP_CORRECTED_RES-100_FAIL-020_ALP-075.txt' using 2:1 title 'Out p_{if}=.20 {/Symbol a}=.75' with l ls 6 , \
'04_plot/01_evaluation/00_data/session_lengthcdf_01_Aerofly_SNAP_CORRECTED_RES-100_FAIL-015_ALP-075.txt' using 2:1 title 'Out p_{if}=.15 {/Symbol a}=.75' with l ls 4 , \
'04_plot/01_evaluation/00_data/session_lengthcdf_01_Aerofly_SNAP_CORRECTED_RES-100_FAIL-000_ALP-075.txt' using 2:1 title 'Out Original {/Symbol a}=.75' with l ls 2,  
