...
set output "fig9_cdf_sessionCount_SENSI_p25_00_01.eps"  
...
'04_plot/01_evaluation/00_data/session_countcdf_00_Collection_SNAP_CORRECTED_RES-100_FAIL-025_ALP-060.txt' using 2:1 title "Out {/Symbol a}=.60 p_{if}=.25" with l ls 4, \
'04_plot/01_evaluation/00_data/session_countcdf_00_Collection_SNAP_CORRECTED_RES-100_FAIL-025_ALP-075.txt' using 2:1 title "Out {/Symbol a}=.75 p_{if}=.25" with l ls 8, \
'04_plot/01_evaluation/00_data/session_countcdf_00_Collection_SNAP_CORRECTED_RES-100_FAIL-025_ALP-095.txt' using 2:1 title "Out {/Symbol a}=.95 p_{if}=.25" with l ls 6, 
...
'04_plot/01_evaluation/00_data/session_countcdf_01_Aerofly_SNAP_CORRECTED_RES-100_FAIL-025_ALP-060.txt' using 2:1 title "Out {/Symbol a}=.60 p_{if}=.25" with l  ls 4, \
'04_plot/01_evaluation/00_data/session_countcdf_01_Aerofly_SNAP_CORRECTED_RES-100_FAIL-025_ALP-075.txt' using 2:1 title "Out {/Symbol a}=.75 p_{if}=.25" with l  ls 8, \
'04_plot/01_evaluation/00_data/session_countcdf_01_Aerofly_SNAP_CORRECTED_RES-100_FAIL-025_ALP-095.txt' using 2:1 title "Out {/Symbol a}=.95 p_{if}=.25" with l  ls 6, 
